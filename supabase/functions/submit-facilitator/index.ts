...
serve(async (req) => {
  ...
  try {
    ...
    const { firstName, lastName, email, phone, location, modality, experience, whyJoin, additionalInfo } = body;
    ...
    const payload = {
      ...
      whyJoin,
      additionalInfo,
      tags: ["facilitator-application"],
      source: "join-facilitator-page",
    ...
    console.error("submit-facilitator error:", err);
