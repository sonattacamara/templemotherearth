...
const SanctuaryWeekLayout = ({ children, title, description, showBackLink = true }: SanctuaryWeekLayoutProps) => {
  ...
  return (
    <div className="sanctuary-spring min-h-screen bg-[hsl(40,33%,97%)] text-[hsl(100,20%,15%)]">
      <SEOHead title={title} description={description} />
      <Navigation />

      {/* Sanctuary Week Announce Bar */}
      <div className="bg-[hsl(40,30%,93%)] border-b border-[hsl(40,25%,85%)] py-2.5 px-6 text-center">
      ...
      {showBackLink && (
        <div className="px-6 md:px-12 py-3 border-b border-[hsl(30,20%,82%)]">
          <Link
            to="/sanctuary-week"
