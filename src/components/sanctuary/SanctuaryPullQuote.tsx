...
const SanctuaryPullQuote = ({ quote, attribution }: SanctuaryPullQuoteProps) => {
  ...
  return (
    <motion.blockquote
      ...
      className="font-serif italic text-[clamp(22px,3vw,32px)] text-[hsl(40,35%,70%)] leading-relaxed px-6 md:px-12 py-12 border-l-2 border-[hsl(40,40%,55%)] mx-6 md:mx-12 my-16"
    >
      {quote}
      {attribution && (
