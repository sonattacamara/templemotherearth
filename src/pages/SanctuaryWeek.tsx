        ...
        <div className="p-6 md:p-7 flex-1 flex flex-col">
          ...
          <div className="flex gap-3 flex-wrap mb-4">
            {card.pricing.map((tier) => (
              <span
                key={tier.label}
                className="font-sans text-[8px] tracking-[1.5px] uppercase text-[hsl(35,30%,68%)]"
              >
  ...
  >
    ...
    <section className="relative min-h-screen flex flex-col justify-end px-6 md:px-12 py-16 md:py-20 overflow-hidden">
      ...
      >
        ...
        <p className="font-serif italic text-[clamp(18px,2vw,24px)] text-[hsl(35,30%,68%)] max-w-[580px] leading-relaxed mb-6">
        ...
        <p className="font-serif text-[16px] text-[hsl(35,20%,58%)] max-w-[520px] leading-relaxed mb-12">
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <Link to="/community-care" className="inline-block font-sans text-[9px] tracking-[3px] uppercase px-10 py-4 bg-transparent border border-[hsla(45,70%,49%,0.4)] text-[hsl(45,70%,49%)] hover:bg-[hsla(45,70%,49%,0.08)] transition-all">
    ...
    <SanctuarySection eyebrow="Sacred Pathways" title={<>Choose Your<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Path of Participation</em></>}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0.5">
        {[
          ...
          <div key={path.title} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-8 text-center">
            ...
            <p className="font-serif text-[14px] text-[hsl(35,20%,42%)]">{path.subtitle}</p>
          </div>
        ))}
      </div>
      <p className="text-center font-sans text-[9px] tracking-[2px] uppercase text-[hsl(35,20%,42%)] mt-8">
        Pay-as-you-go: $444/day · <Link to="/community-care" className="text-[hsl(45,70%,49%)] hover:underline">Community Care Model applies</Link> · Scholarship available
      </p>
    </SanctuarySection>
    ...
    <SanctuarySection eyebrow="Year Six · Spring Equinox 2026" title={<>Six Years Ago<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">We Didn't Know What We Were Building</em></>}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-0.5 mt-16">
        {[
          ...
          <div key={item.label} className="bg-[hsl(105,30%,5%)] p-8 border border-[hsla(45,70%,49%,0.1)] text-center">
    ...
    {/* SACRED APPROACH */}
    <SanctuarySection eyebrow="Our Sacred Approach" title={<>Five Pillars of<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">The Sanctuary Experience</em></>}>
      <div className="grid grid-cols-1 md:grid-cols-5 gap-0.5">
        {[
          ...
          <div key={pillar.num} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-7">
    ...
    <SanctuarySection eyebrow="The Daily Rhythm" title={<>A Day in<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Sanctuary Week</em></>}>
      <p className="text-center text-[19px] text-[hsl(35,30%,68%)] leading-relaxed font-serif max-w-[640px] mx-auto mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0.5">
        {[
          ...
          <div key={slot.time} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-7 flex gap-5">
    ...
    {/* THE ARC OF TEN DAYS */}
    <SanctuarySection eyebrow="The Journey" title={<>The Arc of<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Ten Days</em></>}>
      <p className="text-center text-[19px] text-[hsl(35,30%,68%)] leading-relaxed font-serif max-w-[640px] mx-auto mb-12">
      ...
      <div className="space-y-0.5">
        {[
          ...
          <div key={phase.phase} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-8 md:p-10 flex flex-col md:flex-row gap-5 md:gap-10">
    ...
    {/* FIRST CEREMONY */}
    <SanctuarySection eyebrow="Your First Ceremony" title={<>A Gentle<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Opening</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(35,30%,68%)] max-w-[720px] mx-auto text-center font-serif space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5 mt-12">
        {[
          ...
          <div key={step.num} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-8">
    ...
    {/* TESTIMONIALS */}
    <SanctuarySection eyebrow="Echoes of Others Who Walked This Path" title={<>In Their<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Own Words</em></>}>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5">
        {[
          ...
          <blockquote key={quote} className="bg-[hsl(105,30%,5%)] border border-[hsla(45,70%,49%,0.1)] p-8">
            <p className="font-serif italic text-[17px] text-[hsl(40,30%,90%)] leading-[1.7]">"{quote}"</p>
          </blockquote>
        ))}
      </div>
    </SanctuarySection>
    ...
    <SanctuarySection id="care" eyebrow="Everything is Energy" title={<>Community<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Care Model</em></>}>
      ...
      <div className="text-center mt-10">
        <Link
          to="/community-care"
          className="inline-block font-sans text-[9px] tracking-[3px] uppercase px-10 py-4 border border-[hsla(45,70%,49%,0.4)] text-[hsl(45,70%,49%)] hover:bg-[hsl(45,70%,49%)] hover:text-[hsl(100,20%,3%)] transition-all"
        >
    ...
    <section className="py-20 md:py-28 px-6 md:px-12 text-center bg-gradient-to-t from-[hsl(105,30%,5%)] to-[hsl(100,20%,3%)]">
      <div className="max-w-[640px] mx-auto">
        ...
        <h2 className="font-sans text-[clamp(28px,4.5vw,56px)] font-extralight leading-[1.05] text-[hsl(40,30%,90%)] mb-6">
          Will You Answer<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">the Call?</em>
        </h2>
