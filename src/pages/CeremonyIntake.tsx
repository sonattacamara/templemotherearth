...
const CeremonyIntake = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    facilitatorNotes: "",
    // Inner Landscape (Courtney's full intake)
    pronouns: "",
    breathEasily: "",
    breathPractice: "",
    waterIntake: "",
    ...
    coreEssence: "",
    beingWithSelf: "",
    historyAddiction: "", historyAddictionDetails: "",
    fearsPhobias: "", fearsPhobiasDetails: "",
    energyBlockages: "", energyBlockagesDetails: "",
