...
const tiers = [
  ...
  },
  {
    ...
    icon: Star,
    highlight: false,
    description: "The highest level of sacred commitment. Your monthly contribution secures one local immersion weekend each quarter, plus stewardship within the community.",
    benefits: [
      "Everything in Guardian",
      "1 local immersion weekend per quarter included",
      "Sacred steward recognition & advisory role",
      "Exclusive steward gatherings & dinners",
