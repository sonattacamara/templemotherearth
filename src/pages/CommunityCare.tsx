  ...
  >
    ...
    <section className="relative py-28 md:py-36 px-6 md:px-12 text-center overflow-hidden">
      ...
      <div className="max-w-[800px] mx-auto">
        <p className="font-sans text-[9px] tracking-[4px] uppercase text-primary mb-6">
          Everything Is Energy
        </p>
        <h1 className="font-sans text-[clamp(36px,6vw,72px)] font-extralight leading-[1.05] text-foreground mb-6 tracking-tight">
          Community<br />
          <em className="font-serif italic text-primary text-[1.1em]">Care Model</em>
        </h1>
        <p className="font-serif italic text-[clamp(18px,2vw,24px)] text-muted-foreground max-w-[600px] mx-auto leading-relaxed mb-4">
    ...
    <SanctuarySection
      ...
      title={<>The Invisible<br /><em className="font-serif italic text-primary text-[1.1em]">Work</em></>}
    >
      <div className="max-w-[720px] mx-auto text-center font-serif space-y-6">
        <p className="text-[19px] text-muted-foreground leading-[1.85]">
        ...
        <p className="text-[17px] text-muted-foreground leading-[1.85]">
        ...
        <p className="text-[16px] text-foreground italic mt-8">
    ...
    <hr className="border-t border-primary/10 mx-6 md:mx-12" />

    {/* ═══════ SECTION 2: SACRED RECIPROCITY ═══════ */}
    <SanctuarySection
      eyebrow="The Philosophy"
      title={<>Sacred<br /><em className="font-serif italic text-primary text-[1.1em]">Reciprocity</em></>}
    >
      <div className="max-w-[720px] mx-auto text-center font-serif space-y-6">
        <p className="text-[19px] text-muted-foreground leading-[1.85]">
        ...
        <div className="mt-10 p-8 border border-primary/15 rounded-2xl bg-card">
          <p className="text-[16px] text-foreground italic leading-relaxed">
    ...
    <SanctuarySection
      ...
      title={<>Guardian of<br /><em className="font-serif italic text-primary text-[1.1em]">The Circle</em></>}
    >
      <div className="max-w-[720px] mx-auto text-center font-serif space-y-6">
        <p className="text-[19px] text-muted-foreground leading-[1.85]">
    ...
    <SanctuarySection
      ...
      title={<>Three Ways<br /><em className="font-serif italic text-primary text-[1.1em]">Of Being</em></>}
    >
      <p className="text-center text-[17px] text-muted-foreground font-serif max-w-[600px] mx-auto mb-12 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-2xl p-10">
          <p className="font-sans text-2xl font-extralight text-primary mb-2">Sustainer</p>
          <p className="font-sans text-[9px] tracking-[2px] uppercase text-muted-foreground mb-5">The One Who Holds the Door</p>
          <p className="text-[16px] text-muted-foreground leading-relaxed font-serif mb-6">
          ...
          <p className="text-[14px] text-foreground font-serif italic">
            Your abundance is someone else's access.
          </p>
        </div>
        <div className="bg-card border border-primary/30 rounded-2xl p-10">
          <p className="font-sans text-2xl font-extralight text-primary mb-2">Community</p>
          <p className="font-sans text-[9px] tracking-[2px] uppercase text-muted-foreground mb-5">The One Who Shows Up Anyway</p>
          <p className="text-[16px] text-muted-foreground leading-relaxed font-serif mb-6">
        ...
        <div className="bg-card border border-border rounded-2xl p-10">
          <p className="font-sans text-2xl font-extralight text-primary mb-2">Scholarship</p>
          <p className="font-sans text-[9px] tracking-[2px] uppercase text-muted-foreground mb-5">The One Who Is Called</p>
          <p className="text-[16px] text-muted-foreground leading-relaxed font-serif mb-6">
    ...
    <SanctuarySection
      ...
      title={<>How the Energy<br /><em className="font-serif italic text-primary text-[1.1em]">Flows</em></>}
    >
      <div className="max-w-[720px] mx-auto font-serif space-y-6">
        <p className="text-center text-[19px] text-muted-foreground leading-[1.85]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
          {[
            ...
            <div key={item.label} className="bg-card border border-border rounded-2xl p-8">
              <p className="font-sans text-[10px] tracking-[2px] uppercase text-primary mb-3">{item.label}</p>
              <p className="text-[15px] text-muted-foreground leading-relaxed">{item.desc}</p>
            </div>
          ))}
        </div>
        <p className="text-center text-[16px] text-foreground italic mt-10">
    ...
    <SanctuarySection
      ...
      title={<>Sacred<br /><em className="font-serif italic text-primary text-[1.1em]">Preparation</em></>}
    >
      <div className="max-w-[720px] mx-auto text-center font-serif space-y-6">
        <p className="text-[19px] text-muted-foreground leading-[1.85]">
          Before choosing your tier, sit with this question:
        </p>
        <p className="text-[24px] text-foreground italic leading-relaxed my-8">
    ...
    <section className="py-24 md:py-32 px-6 md:px-12 text-center bg-gradient-warm">
      <div className="max-w-[640px] mx-auto">
        <p className="font-sans text-[9px] tracking-[4px] uppercase text-primary mb-6">
          Your Presence Completes the Circle
        </p>
        <h2 className="font-sans text-[clamp(28px,4.5vw,56px)] font-extralight leading-[1.05] text-foreground mb-6">
          The Circle Is<br /><em className="font-serif italic text-primary text-[1.1em]">Waiting for You</em>
        </h2>
        <p className="text-[19px] text-muted-foreground leading-relaxed font-serif mb-6">
        ...
        <p className="text-[17px] text-muted-foreground leading-relaxed font-serif mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-block rounded-xl bg-primary px-10 py-4 font-body text-sm font-semibold text-primary-foreground transition hover:bg-primary/80"
          >
            Reserve Your Place
          </a>
          <Link
            to="/contact"
            className="inline-block rounded-xl border border-border px-10 py-4 font-body text-sm font-semibold text-foreground transition hover:bg-card"
          >
        ...
        {/* Pull Quote */}
        <div className="mt-16 p-8 border border-primary/15 rounded-2xl bg-card">
          <p className="text-[18px] text-foreground italic leading-relaxed font-serif">
            "The most sacred thing you can do is show up, exactly as you are, with whatever you have. The circle does the rest."
          </p>
          <p className="font-sans text-[8px] tracking-[3px] uppercase text-primary mt-4 opacity-70">
