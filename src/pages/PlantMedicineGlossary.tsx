...
const glossaryData: GlossaryCategory[] = [
  {
    ...
    entries: [
      ...
      { name: "Morning Glory (Ololiuqui)", botanical: "Turbina corymbosa, Ipomoea tricolor", origin: "Mexico — Aztec and Mazatec traditions", description: "LSA-containing seeds used by Aztec and Mazatec peoples for divination and spiritual ceremonies." },
      ...
      { name: "Yopo / Cohoba", botanical: "Anadenanthera peregrina", origin: "Caribbean, South America", description: "DMT and bufotenin-containing seeds traditionally snuffed by indigenous Caribbean and South American peoples for visionary practice." },
  ...
  },
  {
    ...
    entries: [
      ...
      { name: "Damiana", botanical: "Turnera diffusa", origin: "Mexico, Central America", description: "Heart and sensual sacrament traditionally used as an aphrodisiac and mood enhancer. Also used in ceremonial settings for opening the heart." },
