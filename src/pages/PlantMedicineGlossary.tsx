...
const glossaryData = [
  {
    ...
    entries: [
      ...
      { name: "Peyote (Hikuri)", botanical: "Lophophora williamsii", origin: "Mexico, Southwestern United States", description: "Mescaline-containing cactus sacred to Native American Church and Huichol (Wixárika) traditions. Used for prayer, healing, and divine communion." },
...
const PlantMedicineGlossary = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Plant Medicine Glossary — Sacred Earth Medicines & Healing Traditions"
        description="Comprehensive glossary of sacred plant medicines, earth medicines, and healing traditions including Ayahuasca, Kambo, Hapé, psilocybin mushrooms, San Pedro, Iboga, and more. Ceremonies in Washington DC and international retreats."
