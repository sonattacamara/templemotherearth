      ...
      <section className="bg-[#0D0B08] py-24 px-6 md:px-[60px] text-center border-t border-[rgba(200,160,48,0.08)]">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/sacred-series" className="inline-block bg-[#C8A030] text-[#050604] px-[52px] py-[18px] font-sans text-[10px] tracking-[3px] uppercase font-bold border-2 border-[#C8A030] hover:bg-transparent hover:text-[#C8A030] transition-all">
