  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Make a tax-deductible offering to Temple of Mother Earth. Support our sacred ceremony church's mission of spiritual education and community."
        path="/donate"
      />
      <Navigation />
