...
const SacredTeaHouse = () => (
  ...
  >
    {/* Hero - light/sage theme for Tea House */}
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-10 py-20 text-center overflow-hidden bg-[hsl(90,20%,97%)]">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_20%,hsla(110,25%,47%,0.1),transparent_60%)]" />
      <motion.div
      ...
      >
        ...
        <p className="font-serif italic text-[hsl(110,25%,47%)] text-[0.65em] tracking-[3px] text-2xl mt-2 mb-6">Sacred Sacrament Sanctuary</p>
        <p className="font-serif italic text-xl leading-relaxed text-[hsl(120,26%,22%)] max-w-[560px] mx-auto mb-10">
        ...
        <a
          href="#"
          className="inline-block bg-[hsl(110,25%,47%)] text-[hsl(90,20%,97%)] px-12 py-4.5 font-display text-[13px] tracking-[3px] uppercase border-2 border-[hsl(110,25%,47%)] hover:bg-transparent hover:text-[hsl(110,25%,47%)] transition-all"
        >
          Reserve Your Seat
        </a>
      </motion.div>
    ...
    {/* Event Bar */}
    <div className="bg-[hsl(120,26%,22%)] px-6 md:px-10 py-5 flex justify-center gap-12 flex-wrap">
      {[
        ...
        <div key={item.label} className="flex flex-col items-center gap-1">
          <span className="font-display text-[9px] tracking-[3px] uppercase text-[hsl(100,17%,71%)] opacity-70">{item.label}</span>
          <span className="font-display text-[14px] font-semibold text-[hsl(40,24%,92%)]">{item.val}</span>
        </div>
      ))}
    </div>

    {/* Tea Menu */}
    <section className="px-6 md:px-10 py-20 max-w-[900px] mx-auto bg-[hsl(90,20%,97%)]">
      <p className="font-display text-[10px] tracking-[5px] uppercase text-[hsl(110,25%,47%)] text-center mb-4">The Tea Menu</p>
      <h2 className="font-display text-[clamp(22px,3vw,34px)] text-[hsl(108,28%,13%)] text-center mb-12 font-normal">Sacred Plant Offerings</h2>
    ...
    {/* Tea Ceremony */}
    <section className="bg-[hsl(108,28%,13%)] text-[hsl(40,24%,92%)] px-6 md:px-10 py-20">
      <div className="max-w-[900px] mx-auto">
        <p className="font-display text-[10px] tracking-[5px] uppercase text-[hsl(45,50%,53%)] text-center mb-4">The Practice</p>
        <h2 className="font-display text-[clamp(22px,3vw,34px)] text-center mb-6 font-normal text-[hsl(40,24%,92%)]">The Tea Ceremony</h2>
        <p className="font-serif italic text-[19px] leading-relaxed max-w-[700px] mx-auto text-center opacity-80 mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {steps.map((step) => (
            <div key={step.num} className="text-center">
              <p className="font-display text-5xl text-[hsla(45,50%,53%,0.2)] leading-none mb-3">{step.num}</p>
              <h4 className="font-display text-[12px] tracking-[2px] text-[hsl(45,50%,53%)] mb-2.5 font-normal">{step.title}</h4>
              <p className="text-[15px] leading-relaxed opacity-70 font-serif">{step.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    {/* Benefits */}
    <section className="bg-[hsl(40,24%,92%)] px-6 md:px-10 py-20">
      <div className="max-w-[900px] mx-auto">
        <p className="font-display text-[10px] tracking-[5px] uppercase text-[hsl(110,25%,47%)] text-center mb-4">Sacred Sacrament</p>
        <h2 className="font-display text-[clamp(22px,3vw,34px)] text-[hsl(108,28%,13%)] text-center mb-12 font-normal">Why Sacred Tea?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {benefits.map((b) => (
            <div key={b.title} className="p-7 border border-[hsla(110,25%,47%,0.2)]">
              <h4 className="font-display text-[12px] tracking-[2px] text-[hsl(120,26%,22%)] mb-2 font-normal">{b.title}</h4>
              <p className="text-[15px] leading-relaxed text-[hsl(110,15%,47%)] font-serif">{b.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    {/* CTA */}
    <section className="bg-gradient-to-br from-[hsl(120,26%,22%)] to-[hsl(108,28%,13%)] py-24 px-6 md:px-10 text-center">
      <h2 className="font-display text-[clamp(22px,3vw,40px)] text-[hsl(40,24%,92%)] mb-4 font-normal">The Tea House Awaits</h2>
      <p className="text-[hsl(100,17%,71%)] font-serif italic text-xl mb-10">A monthly sanctuary of slowness and sacred sacrament</p>
      <a
        href="#"
        className="inline-block bg-[hsl(45,50%,53%)] text-[hsl(108,28%,13%)] px-12 py-4.5 font-display text-[13px] tracking-[3px] uppercase border-2 border-[hsl(45,50%,53%)] hover:bg-transparent hover:text-[hsl(45,50%,53%)] transition-all"
      >
        Reserve Your Seat
      </a>
      <p className="mt-6 text-[12px] font-display tracking-[2px] text-[hsl(40,24%,92%)] opacity-40">Temple Mother Earth · Spring Equinox 2026</p>
    </section>
  </SanctuaryWeekLayout>
);
