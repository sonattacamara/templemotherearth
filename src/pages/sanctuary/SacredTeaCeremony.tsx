  ...
  >
    ...
    <SanctuarySection id="about" eyebrow="The Sacrament" title={<>What the Ancients Called<br /><em className="font-serif italic text-[hsl(35,55%,42%)] text-[1.1em]">The Fruit of the Gods</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(90,10%,35%)] max-w-[720px] font-serif space-y-6">
        ...
        <p>What arrives in ceremony is specific to what you are carrying. <strong className="text-[hsl(100,20%,15%)]">It gives each person exactly what they are ready to receive.</strong></p>
    ...
    <SanctuarySection id="levels" eyebrow="Three Levels of Entry" title={<>Choose the Depth<br /><em className="font-serif italic text-[hsl(35,55%,42%)] text-[1.1em]">You Are Ready For</em></>}>
      ...
      <p className="mt-12 text-[hsl(90,10%,50%)] text-[16px] font-sans tracking-[2px] uppercase">
