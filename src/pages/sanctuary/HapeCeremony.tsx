...
const HapeCeremony = () => (
  ...
  >
    <SanctuaryHero
      ...
      title={<>The Noise Stops.<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.15em]">You Remember.</em></>}
      subtitle=""
    ...
    <SanctuarySection id="about" eyebrow="What Hapé Is" title={<>The Forest's Most<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Direct Transmission</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(35,30%,68%)] max-w-[720px] font-serif space-y-6">
        ...
        <p>Within moments, <strong className="text-[hsl(40,30%,90%)]">the mind goes quiet.</strong> Not suppressed, cleared. The third eye opens. The body drops into the earth. The frantic noise of ordinary life falls away and what remains is you, unadorned, present, exactly here.</p>
    ...
    <SanctuarySection eyebrow="Who This Is For" title={<>You Know When<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Something Is Calling You</em></>}>
    ...
    <SanctuarySection eyebrow="What to Expect" title={<>A Ceremony With<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Ancient Structure</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(35,30%,68%)] max-w-[720px] font-serif space-y-6">
        <p><strong className="text-[hsl(40,30%,90%)]">Opening circle.</strong> We sit together, set intentions, open sacred space. You speak what you are bringing to the ceremony and what you are asking to release.</p>
        <p><strong className="text-[hsl(40,30%,90%)]">Rapé administration.</strong> Our facilitator administers the sacrament through the nose using the tepi pipe. The experience peaks quickly, intense, complete, specific.</p>
        <p><strong className="text-[hsl(40,30%,90%)]">Sitting with what arrives.</strong> After administration, you rest in the ceremony container. Sound, silence, and space support the integration happening in real time.</p>
        <p><strong className="text-[hsl(40,30%,90%)]">Closing and sharing.</strong> We close sacred space together. Participants share what moved through them. You leave knowing you were witnessed.</p>
        <p className="text-[hsl(45,70%,49%)] italic">Expect intensity. Expect clarity. Expect to feel more like yourself than you have in a long time.</p>
      </div>
    </SanctuarySection>

    <SanctuaryCTA
      eyebrow="Thursday · March 19 · 2026"
      title={<>The Forest<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Has Been Waiting</em></>}
