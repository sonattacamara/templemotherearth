...
const SacredYinYoga = () => (
  ...
  >
    <SanctuaryHero
      ...
      title={<>You Already Know<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.15em]">How to Surrender</em></>}
      subtitle=""
    ...
    <SanctuarySection id="about" eyebrow="What Sacred Yin Is" title={<>Not Exercise.<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Ceremony in the Body.</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(35,30%,68%)] max-w-[720px] font-serif space-y-6">
        ...
        <p>Most of us have been trained to push through. Yin asks for the opposite: <strong className="text-[hsl(40,30%,90%)]">to arrive, to feel, and to let the body open in its own time.</strong></p>
    ...
    <SanctuarySection eyebrow="The 90-Minute Journey" title={<>Meditation<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">in Motion</em></>}>
    ...
    <SanctuaryCTA
      ...
      title={<>Your Body<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Is Ready to Rest</em></>}
