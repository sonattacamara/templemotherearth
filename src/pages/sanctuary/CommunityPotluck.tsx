...
const CommunityPotluck = () => (
  ...
  >
    <SanctuaryHero
      ...
      title={<>You Are Already<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.15em]">Part of This Family</em></>}
      subtitle=""
    ...
    <SanctuarySection id="about" eyebrow="What This Is" title={<>Not a Networking Event.<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">A Home.</em></>}>
      <div className="text-xl leading-[1.85] text-[hsl(35,30%,68%)] max-w-[720px] font-serif space-y-6">
        ...
        <p><strong className="text-[hsl(40,30%,90%)]">People who have sat in ceremony and are integrating. People who are curious and drawn but haven't stepped in yet. People who are just looking for a table where the conversation goes somewhere real.</strong></p>
    ...
    <SanctuarySection eyebrow="The Evening" title={<>Three Spaces.<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">One Family.</em></>}>
    ...
    <SanctuaryCTA
      ...
      title={<>The Table<br /><em className="font-serif italic text-[hsl(45,70%,49%)] text-[1.1em]">Is Already Set For You</em></>}
